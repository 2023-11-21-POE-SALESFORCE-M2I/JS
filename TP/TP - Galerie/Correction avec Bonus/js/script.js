...
document.body.addEventListener('keydown', function(e){
    ...
    if(e.key === 'h' || e.key === 'H' && !document.querySelector('.overlay')){ // condition dans laquelle on agit si la touche pressée est h ET si l'overlay n'est actuellement pas présent dans la page
